...
extension Localization on String {
  ...
  static var _t = Translations("en") +
      ...
      {
        "en": "Coupon use limit exceeded",
        "fr": "Limite d'utilisation du coupon dépassée",
        "es": "Se superó el límite de uso del cupón",
        "de": "Gutschein-Einsatzlimit überschritten",
        "pt": "Limite de uso de cupom excedido",
        "ar": "تم تجاوز حد استخدام القسيمة",
        "ko": "쿠폰 사용 한도 초과"
      } +
      {
        "en": "Coupon has expired",
        "fr": "Le coupon a expiré",
        "es": "El cupón ha caducado",
        "de": "Gutschein ist abgelaufen",
        "pt": "O cupom expirou",
